...
insert into Usuario (id, nombre, apellidos, email, nickname, password, telefono, cuenta_caducada, cuenta_bloqueada, credenciales_caducadas, admin) values (11115, 'Admin', 'Admin', 'admin@admin.com', 'Admin', 'admin', '666666666', false, false, false, true);
insert into Usuario (id, nombre, apellidos, email, nickname, password, telefono, cuenta_caducada, cuenta_bloqueada, credenciales_caducadas, admin) values (11116, 'Usuario', 'Usuario', 'usuario@usuario.com', 'Usuario', '1234', '777777777', false, false, false, false);
